...
def main():
    ...
    tab1, tab2, tab3 ,tab4= st.tabs(["🌤 Weather Forecast", "🌱 Crop Recommendation", "🏛 Government Schemes","🐛 Pest Management"])

    with tab1:
        st.markdown("### 🌦 Weather Forecast", help="Get real-time weather even for villages")
